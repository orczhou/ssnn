...
\
'''
print(about_the_train.format(learning_rate,iteration_count,n1,m,batch_size))
...
for i in range(iteration_count):
    ...
    for i_batch in range(batch_iteration):
        ...
        #     think about that if for some sample a2 = 0 or 1
        ...
        # if (i+1)%(iteration_count/150) == 0 and (i_batch+1)%(batch_iteration/20) ==0 :
        # if (i_batch+1)%(round(batch_iteration/150)) == 0 :
